...
"
  ...
  if getline(1) =~ "^0\\{7,8}:"   " only if it worked
    set ft=xxd
  else
...
" Get the current line number but -1 to use base 0 to make the *16 work right.
  ...
  if curcol > 49
      " Make it 49.  We don't care about the text to the right of the hex.
      let curcol = 49
  endif
...
"
  ...
  if curcol > 51
    ...
    " init newcol first ascii position is 52
